...
#     def __init__(self, objs, r, f=64, k=2, log=None):
#         """
...
#                 if(len(dups)>0):
#                     for dup in dups:
#                         dup = str(dup.decode('utf-8'))
#                         sim2, obj_id = dup.split(',', 1)
#                         sim2 = Simhash(long(sim2[2:], 16), self.f)

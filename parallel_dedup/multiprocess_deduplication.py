...
from utils.utils import jaccard_distance, get_all_files
import tqdm
...
def deduplication(file_path_list, rs_pkl, simhash_threshold, similar_file_queue, flag):
...
def files_deplication(src_dir = 'output_csv/', rs_pkl = None, simhash_threshold = 3, jaccard_thresold = 0.8 , n_process = 13):
    """
    将多个csv中的文件进行去重
    ...
    deduplication(file_path_list, rs_pkl, simhash_threshold, similar_file_queue, flag)
...
if __name__ == '__main__':
    ...
    # 调用convert函数
    files_deplication(args.src_dir, args.rs_pkl, args.simhash_threshold, args.jaccard_thresold, args.n_process)